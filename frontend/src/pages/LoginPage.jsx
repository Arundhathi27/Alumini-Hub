            ...
            >
                ...
                {error && (
                    <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
                        style={{
                            color: '#ef4444', backgroundColor: '#fee2e2', padding: '0.75rem',
                            borderRadius: '0.5rem', marginBottom: '1rem', fontSize: '0.875rem', textAlign: 'center'
                        }}>
                        {error}
                    </motion.div>
                )}
                ...
                <form onSubmit={handleSubmit} className={styles.form}>
                    ...
                    <motion.button type="submit" className={styles.button}
                        ...
                        {isLoading ? <span>Signing In...</span> : <><span>Sign In</span><LogIn size={18} style={{ marginLeft: '0.5rem' }} /></>}
                    </motion.button>
                </form>

                <div className={styles.footer}>
                    <p>Having trouble accessing? <a href="#" className={styles.contactLink}>Contact Admin</a></p>
                </div>
            </motion.div>
        </div>
    );
