...
const breadcrumbMap = {
    ...
    '/staff/job-approvals': 'Job Approvals',
    '/staff/event-approvals': 'Event Approvals',
    '/staff/events': 'Events',
    '/staff/alumni': 'Alumni Directory',
        ...
        <header className={styles.topbar}>
            ...
            <div className={styles.profileSection}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    <span className={styles.avatarName}>{user?.name || 'Staff'}</span>
                </div>
            </div>
        </header>
    );
